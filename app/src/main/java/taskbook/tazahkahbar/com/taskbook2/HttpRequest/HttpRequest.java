package taskbook.tazahkahbar.com.taskbook2.HttpRequest;
...
import static taskbook.tazahkahbar.com.taskbook2.Utilities.utils.hideSoftKeyboard;
    ...
    static public JSONObject SyncHttpRequest (final Context c, String url, HashMap<String,String> hashMap, final ProgressBar progressBar){
        ...
        requestQueue.add(request);
         ...
         try {
             ...
             Toast.makeCustomErrorToast(c,"Connection Error");
            // exception handling
             ...
             Toast.makeCustomErrorToast(c,"Connection Timeout");
